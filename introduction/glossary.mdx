...
#### Iterator
Some inputs are too large to process through models so you need to use iterators. Iterators are ways of splitting up an input (for example a video) into parts, and running each part through a chain.

#### Stream
Activities like text_to_video and text_to_audio can take time to process, so you can use the stream API to listen in on updates


#### Deployment
Once your chain is ready and you're happy with the results, you can deploy it using one of 4 methods: 
